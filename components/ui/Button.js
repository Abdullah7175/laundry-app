...
const Button = ({
  ...
  const variantClasses = {
    ...
    outline: 'text-blue-700 bg-white hover:bg-blue-50 focus:ring-blue-500 border border-blue-300',
    ...
    light: 'text-gray-700 bg-gray-100 hover:bg-gray-200 focus:ring-gray-500 border border-transparent',
  };

  const getWidth = isFullWidth ? 'w-full' : '';
  const getDisabled = isDisabled ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-sm';
