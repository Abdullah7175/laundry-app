          ...
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 flex-1 px-2 space-y-1">
              <Link href="/delivery/dashboard">
                <a className={`${router.pathname === '/delivery/dashboard' ? 'bg-blue-800 text-white' : 'text-white hover:bg-blue-600'} group flex items-center px-2 py-2 text-sm font-medium rounded-md`}>
              ...
              <Link href="/delivery/routes">
                <a className={`${router.pathname === '/delivery/routes' ? 'bg-blue-800 text-white' : 'text-white hover:bg-blue-600'} group flex items-center px-2 py-2 text-sm font-medium rounded-md`}>
                  <svg className="mr-3 h-6 w-6 text-blue-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <Link href="/delivery/history">
                <a className={`${router.pathname === '/delivery/history' ? 'bg-blue-800 text-white' : 'text-white hover:bg-blue-600'} group flex items-center px-2 py-2 text-sm font-medium rounded-md`}>
                  <svg className="mr-3 h-6 w-6 text-blue-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
